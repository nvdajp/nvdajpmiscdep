...
_jtalk_voices = [
	...
	{"id": "V2A",
	 ...
	 "pitch_bias": 0,
	 "speaker_attenuation": 0.5,
	 "htsvoice": os.path.join(jtalk_dir, 'mei', 'mei_angry.htsvoice'),
	 "espeak_variant": "f1"},
	{"id": "V2B",
	 "name": "mei_b",
	 "lang":"ja",
	 ...
	 "pitch_bias": 0,
	 "speaker_attenuation": 0.5,
	 "htsvoice": os.path.join(jtalk_dir, 'mei', 'mei_bashful.htsvoice'),
	 "espeak_variant": "f1"},
	{"id": "V2H",
	 "name": "mei_h",
	 "lang":"ja",
	...
	{"id": "V2S",
	 ...
	 "pitch_bias": 0,
	 "speaker_attenuation": 0.5,
	 "htsvoice": os.path.join(jtalk_dir, 'mei', 'mei_sad.htsvoice'),
	 "espeak_variant": "f1"},
]
